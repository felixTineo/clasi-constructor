    ...
    <Footer>
      <MainFooter>
        <Container>
          <Row>
            <Col xs={12} md={4}>
              <img src={state.office.logo} />
              <OfficeInfoCont>
                <OfficeInfo>
                  {state.office.address}
                </OfficeInfo>
                <OfficeInfo>
                  {`(${state.office.phone.countryCode}-${state.office.phone.areaCode}) ${state.office.phone.phoneNumber} / (${state.office.mobile.countryCode}-${state.office.mobile.areaCode}) ${state.office.mobile.phoneNumber}`}
                </OfficeInfo>
                <OfficeInfo>
                  {state.office.email}
                </OfficeInfo>
